...
def runALS(A, R, n_factors, n_iterations, lambda_):
    ...
    '''
    print ("Initiating ")
    lambda_ = 0.1; n_factors = 3; n, m = A.shape; n_iterations = 20 #n_factors is k here
    Users = 5 * np.random.rand(n, n_factors) #N X K = U
    Items = 5 * np.random.rand(n_factors, m) #K X M = V
